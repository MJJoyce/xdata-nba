...
public class Preview extends org.apache.gora.persistency.impl.PersistentBase implements org.apache.avro.specific.SpecificRecord, org.apache.gora.persistency.Persistent {
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Preview\",\"namespace\":\"gov.nasa.jpl.xdata.nba.impoexpo\",\"fields\":[{\"name\":\"__g__dirty\",\"type\":\"bytes\",\"doc\":\"Bytes used to represent weather or not a field is dirty.\",\"default\":\"AA==\"},{\"name\":\"previewText\",\"type\":[\"null\",\"string\"],\"default\":null}]}");
  ...
  public static gov.nasa.jpl.xdata.nba.impoexpo.Preview.Builder newBuilder() {
    return new gov.nasa.jpl.xdata.nba.impoexpo.Preview.Builder();
  }
  
  /** Creates a new Preview RecordBuilder by copying an existing Builder */
  public static gov.nasa.jpl.xdata.nba.impoexpo.Preview.Builder newBuilder(gov.nasa.jpl.xdata.nba.impoexpo.Preview.Builder other) {
    return new gov.nasa.jpl.xdata.nba.impoexpo.Preview.Builder(other);
  }
  
  /** Creates a new Preview RecordBuilder by copying an existing Preview instance */
  public static gov.nasa.jpl.xdata.nba.impoexpo.Preview.Builder newBuilder(gov.nasa.jpl.xdata.nba.impoexpo.Preview other) {
    return new gov.nasa.jpl.xdata.nba.impoexpo.Preview.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Preview>
    ...
    private Builder() {
      super(gov.nasa.jpl.xdata.nba.impoexpo.Preview.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(gov.nasa.jpl.xdata.nba.impoexpo.Preview.Builder other) {
      super(other);
    }
    
    /** Creates a Builder by copying an existing Preview instance */
    private Builder(gov.nasa.jpl.xdata.nba.impoexpo.Preview other) {
            super(gov.nasa.jpl.xdata.nba.impoexpo.Preview.SCHEMA$);
    ...
    /** Sets the value of the 'previewText' field */
    public gov.nasa.jpl.xdata.nba.impoexpo.Preview.Builder setPreviewText(java.lang.CharSequence value) {
    ...
    public gov.nasa.jpl.xdata.nba.impoexpo.Preview.Builder clearPreviewText() {
      previewText = null;
