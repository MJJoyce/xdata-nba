...
public class OtherStats extends org.apache.gora.persistency.impl.PersistentBase implements org.apache.avro.specific.SpecificRecord, org.apache.gora.persistency.Persistent {
  ...
  public void put(int field$, java.lang.Object value) {
    ...
    case 1: leagueId = (java.lang.Integer)(value); break;
    case 2: seasonId = (java.lang.Integer)(value); break;
    ...
    case 6: ptsPaint = (java.lang.Integer)(value); break;
    case 7: pts2ndChance = (java.lang.Integer)(value); break;
    case 8: ptsFb = (java.lang.Long)(value); break;
    case 9: largestLead = (java.lang.Integer)(value); break;
    case 10: leadChanges = (java.lang.Integer)(value); break;
  ...
  public static gov.nasa.jpl.xdata.nba.impoexpo.OtherStats.Builder newBuilder() {
    return new gov.nasa.jpl.xdata.nba.impoexpo.OtherStats.Builder();
  }
  
  /** Creates a new OtherStats RecordBuilder by copying an existing Builder */
  public static gov.nasa.jpl.xdata.nba.impoexpo.OtherStats.Builder newBuilder(gov.nasa.jpl.xdata.nba.impoexpo.OtherStats.Builder other) {
    return new gov.nasa.jpl.xdata.nba.impoexpo.OtherStats.Builder(other);
  }
  
  /** Creates a new OtherStats RecordBuilder by copying an existing OtherStats instance */
  public static gov.nasa.jpl.xdata.nba.impoexpo.OtherStats.Builder newBuilder(gov.nasa.jpl.xdata.nba.impoexpo.OtherStats other) {
    return new gov.nasa.jpl.xdata.nba.impoexpo.OtherStats.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<OtherStats>
    ...
    private Builder() {
      super(gov.nasa.jpl.xdata.nba.impoexpo.OtherStats.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(gov.nasa.jpl.xdata.nba.impoexpo.OtherStats.Builder other) {
      super(other);
    }
    
    /** Creates a Builder by copying an existing OtherStats instance */
    private Builder(gov.nasa.jpl.xdata.nba.impoexpo.OtherStats other) {
            super(gov.nasa.jpl.xdata.nba.impoexpo.OtherStats.SCHEMA$);
      ...
      if (isValidValue(fields()[1], other.leagueId)) {
        this.leagueId = (java.lang.Integer) data().deepCopy(fields()[1].schema(), other.leagueId);
        fieldSetFlags()[1] = true;
      }
      if (isValidValue(fields()[2], other.seasonId)) {
        this.seasonId = (java.lang.Integer) data().deepCopy(fields()[2].schema(), other.seasonId);
      ...
      if (isValidValue(fields()[6], other.ptsPaint)) {
        this.ptsPaint = (java.lang.Integer) data().deepCopy(fields()[6].schema(), other.ptsPaint);
        fieldSetFlags()[6] = true;
      }
      if (isValidValue(fields()[7], other.pts2ndChance)) {
        this.pts2ndChance = (java.lang.Integer) data().deepCopy(fields()[7].schema(), other.pts2ndChance);
      ...
      if (isValidValue(fields()[9], other.largestLead)) {
        this.largestLead = (java.lang.Integer) data().deepCopy(fields()[9].schema(), other.largestLead);
        fieldSetFlags()[9] = true;
      }
      if (isValidValue(fields()[10], other.leadChanges)) {
        this.leadChanges = (java.lang.Integer) data().deepCopy(fields()[10].schema(), other.leadChanges);
    ...
    /** Sets the value of the 'leagueId' field */
    public gov.nasa.jpl.xdata.nba.impoexpo.OtherStats.Builder setLeagueId(int value) {
    ...
    public gov.nasa.jpl.xdata.nba.impoexpo.OtherStats.Builder clearLeagueId() {
    ...
    /** Sets the value of the 'seasonId' field */
    public gov.nasa.jpl.xdata.nba.impoexpo.OtherStats.Builder setSeasonId(int value) {
    ...
    public gov.nasa.jpl.xdata.nba.impoexpo.OtherStats.Builder clearSeasonId() {
    ...
    /** Sets the value of the 'teamId' field */
    public gov.nasa.jpl.xdata.nba.impoexpo.OtherStats.Builder setTeamId(int value) {
    ...
    public gov.nasa.jpl.xdata.nba.impoexpo.OtherStats.Builder clearTeamId() {
    ...
    /** Sets the value of the 'teamAbbreviation' field */
    public gov.nasa.jpl.xdata.nba.impoexpo.OtherStats.Builder setTeamAbbreviation(java.lang.CharSequence value) {
    ...
    public gov.nasa.jpl.xdata.nba.impoexpo.OtherStats.Builder clearTeamAbbreviation() {
    ...
    /** Sets the value of the 'teamCity' field */
    public gov.nasa.jpl.xdata.nba.impoexpo.OtherStats.Builder setTeamCity(java.lang.CharSequence value) {
    ...
    public gov.nasa.jpl.xdata.nba.impoexpo.OtherStats.Builder clearTeamCity() {
      teamCity = null;
    ...
    /** Sets the value of the 'ptsPaint' field */
    public gov.nasa.jpl.xdata.nba.impoexpo.OtherStats.Builder setPtsPaint(int value) {
    ...
    public gov.nasa.jpl.xdata.nba.impoexpo.OtherStats.Builder clearPtsPaint() {
    ...
    /** Sets the value of the 'pts2ndChance' field */
    public gov.nasa.jpl.xdata.nba.impoexpo.OtherStats.Builder setPts2ndChance(int value) {
    ...
    public gov.nasa.jpl.xdata.nba.impoexpo.OtherStats.Builder clearPts2ndChance() {
    ...
    /** Sets the value of the 'ptsFb' field */
    public gov.nasa.jpl.xdata.nba.impoexpo.OtherStats.Builder setPtsFb(long value) {
    ...
    public gov.nasa.jpl.xdata.nba.impoexpo.OtherStats.Builder clearPtsFb() {
    ...
    /** Sets the value of the 'largestLead' field */
    public gov.nasa.jpl.xdata.nba.impoexpo.OtherStats.Builder setLargestLead(int value) {
    ...
    public gov.nasa.jpl.xdata.nba.impoexpo.OtherStats.Builder clearLargestLead() {
    ...
    /** Sets the value of the 'leadChanges' field */
    public gov.nasa.jpl.xdata.nba.impoexpo.OtherStats.Builder setLeadChanges(int value) {
    ...
    public gov.nasa.jpl.xdata.nba.impoexpo.OtherStats.Builder clearLeadChanges() {
    ...
    /** Sets the value of the 'timesTied' field */
    public gov.nasa.jpl.xdata.nba.impoexpo.OtherStats.Builder setTimesTied(long value) {
    ...
    public gov.nasa.jpl.xdata.nba.impoexpo.OtherStats.Builder clearTimesTied() {
    ...
    public OtherStats build() {
      try {
        ...
        record.leagueId = fieldSetFlags()[1] ? this.leagueId : (java.lang.Integer) defaultValue(fields()[1]);
        record.seasonId = fieldSetFlags()[2] ? this.seasonId : (java.lang.Integer) defaultValue(fields()[2]);
        ...
        record.ptsPaint = fieldSetFlags()[6] ? this.ptsPaint : (java.lang.Integer) defaultValue(fields()[6]);
        record.pts2ndChance = fieldSetFlags()[7] ? this.pts2ndChance : (java.lang.Integer) defaultValue(fields()[7]);
        record.ptsFb = fieldSetFlags()[8] ? this.ptsFb : (java.lang.Long) defaultValue(fields()[8]);
        record.largestLead = fieldSetFlags()[9] ? this.largestLead : (java.lang.Integer) defaultValue(fields()[9]);
        record.leadChanges = fieldSetFlags()[10] ? this.leadChanges : (java.lang.Integer) defaultValue(fields()[10]);
