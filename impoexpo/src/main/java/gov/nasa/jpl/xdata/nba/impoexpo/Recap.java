...
public class Recap extends org.apache.gora.persistency.impl.PersistentBase implements org.apache.avro.specific.SpecificRecord, org.apache.gora.persistency.Persistent {
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Recap\",\"namespace\":\"gov.nasa.jpl.xdata.nba.impoexpo\",\"fields\":[{\"name\":\"__g__dirty\",\"type\":\"bytes\",\"doc\":\"Bytes used to represent weather or not a field is dirty.\",\"default\":\"AA==\"},{\"name\":\"recapText\",\"type\":[\"null\",\"string\"],\"default\":null}]}");
  ...
  public static gov.nasa.jpl.xdata.nba.impoexpo.Recap.Builder newBuilder() {
    return new gov.nasa.jpl.xdata.nba.impoexpo.Recap.Builder();
  }
  
  /** Creates a new Recap RecordBuilder by copying an existing Builder */
  public static gov.nasa.jpl.xdata.nba.impoexpo.Recap.Builder newBuilder(gov.nasa.jpl.xdata.nba.impoexpo.Recap.Builder other) {
    return new gov.nasa.jpl.xdata.nba.impoexpo.Recap.Builder(other);
  }
  
  /** Creates a new Recap RecordBuilder by copying an existing Recap instance */
  public static gov.nasa.jpl.xdata.nba.impoexpo.Recap.Builder newBuilder(gov.nasa.jpl.xdata.nba.impoexpo.Recap other) {
    return new gov.nasa.jpl.xdata.nba.impoexpo.Recap.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Recap>
    ...
    private Builder() {
      super(gov.nasa.jpl.xdata.nba.impoexpo.Recap.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(gov.nasa.jpl.xdata.nba.impoexpo.Recap.Builder other) {
      super(other);
    }
    
    /** Creates a Builder by copying an existing Recap instance */
    private Builder(gov.nasa.jpl.xdata.nba.impoexpo.Recap other) {
            super(gov.nasa.jpl.xdata.nba.impoexpo.Recap.SCHEMA$);
    ...
    /** Sets the value of the 'recapText' field */
    public gov.nasa.jpl.xdata.nba.impoexpo.Recap.Builder setRecapText(java.lang.CharSequence value) {
    ...
    public gov.nasa.jpl.xdata.nba.impoexpo.Recap.Builder clearRecapText() {
      recapText = null;
