...
public class AvailableVideo extends org.apache.gora.persistency.impl.PersistentBase implements org.apache.avro.specific.SpecificRecord, org.apache.gora.persistency.Persistent {
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"AvailableVideo\",\"namespace\":\"gov.nasa.jpl.xdata.nba.impoexpo\",\"fields\":[{\"name\":\"__g__dirty\",\"type\":\"bytes\",\"doc\":\"Bytes used to represent weather or not a field is dirty.\",\"default\":\"AA==\"},{\"name\":\"videoAvailableFlag\",\"type\":\"int\",\"default\":0}]}");
  ...
  public void put(int field$, java.lang.Object value) {
    ...
    case 1: videoAvailableFlag = (java.lang.Integer)(value); break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
  ...
  public static gov.nasa.jpl.xdata.nba.impoexpo.AvailableVideo.Builder newBuilder() {
    return new gov.nasa.jpl.xdata.nba.impoexpo.AvailableVideo.Builder();
  }
  
  /** Creates a new AvailableVideo RecordBuilder by copying an existing Builder */
  public static gov.nasa.jpl.xdata.nba.impoexpo.AvailableVideo.Builder newBuilder(gov.nasa.jpl.xdata.nba.impoexpo.AvailableVideo.Builder other) {
    return new gov.nasa.jpl.xdata.nba.impoexpo.AvailableVideo.Builder(other);
  }
  
  /** Creates a new AvailableVideo RecordBuilder by copying an existing AvailableVideo instance */
  public static gov.nasa.jpl.xdata.nba.impoexpo.AvailableVideo.Builder newBuilder(gov.nasa.jpl.xdata.nba.impoexpo.AvailableVideo other) {
    return new gov.nasa.jpl.xdata.nba.impoexpo.AvailableVideo.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<AvailableVideo>
    ...
    private Builder() {
      super(gov.nasa.jpl.xdata.nba.impoexpo.AvailableVideo.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(gov.nasa.jpl.xdata.nba.impoexpo.AvailableVideo.Builder other) {
      super(other);
    }
    
    /** Creates a Builder by copying an existing AvailableVideo instance */
    private Builder(gov.nasa.jpl.xdata.nba.impoexpo.AvailableVideo other) {
            super(gov.nasa.jpl.xdata.nba.impoexpo.AvailableVideo.SCHEMA$);
      ...
      if (isValidValue(fields()[1], other.videoAvailableFlag)) {
        this.videoAvailableFlag = (java.lang.Integer) data().deepCopy(fields()[1].schema(), other.videoAvailableFlag);
    ...
    /** Sets the value of the 'videoAvailableFlag' field */
    public gov.nasa.jpl.xdata.nba.impoexpo.AvailableVideo.Builder setVideoAvailableFlag(int value) {
    ...
    public gov.nasa.jpl.xdata.nba.impoexpo.AvailableVideo.Builder clearVideoAvailableFlag() {
    ...
    public AvailableVideo build() {
      try {
        ...
        record.videoAvailableFlag = fieldSetFlags()[1] ? this.videoAvailableFlag : (java.lang.Integer) defaultValue(fields()[1]);
        return record;
      } catch (Exception e) {
