...
public class GameStats extends org.apache.gora.persistency.impl.PersistentBase implements org.apache.avro.specific.SpecificRecord, org.apache.gora.persistency.Persistent {
  ...
  private gov.nasa.jpl.xdata.nba.impoexpo.GameSummary gameSummary;
  private gov.nasa.jpl.xdata.nba.impoexpo.LineScore lineScore;
  private gov.nasa.jpl.xdata.nba.impoexpo.SeasonSeries seasonSeries;
  private gov.nasa.jpl.xdata.nba.impoexpo.LastMeeting lastMeeting;
  private gov.nasa.jpl.xdata.nba.impoexpo.PlayerStats playerStats;
  private gov.nasa.jpl.xdata.nba.impoexpo.TeamStats teamStats;
  private gov.nasa.jpl.xdata.nba.impoexpo.OtherStats otherStats;
  private gov.nasa.jpl.xdata.nba.impoexpo.Officials officials;
  private gov.nasa.jpl.xdata.nba.impoexpo.GameInfo gameInfo;
  private gov.nasa.jpl.xdata.nba.impoexpo.InactivePlayers inactivePlayers;
  private gov.nasa.jpl.xdata.nba.impoexpo.AvailableVideo availableVideo;
  private int gameId;
  ...
  public void put(int field$, java.lang.Object value) {
    ...
    case 1: gameSummary = (gov.nasa.jpl.xdata.nba.impoexpo.GameSummary)(value); break;
    case 2: lineScore = (gov.nasa.jpl.xdata.nba.impoexpo.LineScore)(value); break;
    case 3: seasonSeries = (gov.nasa.jpl.xdata.nba.impoexpo.SeasonSeries)(value); break;
    case 4: lastMeeting = (gov.nasa.jpl.xdata.nba.impoexpo.LastMeeting)(value); break;
    case 5: playerStats = (gov.nasa.jpl.xdata.nba.impoexpo.PlayerStats)(value); break;
    case 6: teamStats = (gov.nasa.jpl.xdata.nba.impoexpo.TeamStats)(value); break;
    case 7: otherStats = (gov.nasa.jpl.xdata.nba.impoexpo.OtherStats)(value); break;
    case 8: officials = (gov.nasa.jpl.xdata.nba.impoexpo.Officials)(value); break;
    case 9: gameInfo = (gov.nasa.jpl.xdata.nba.impoexpo.GameInfo)(value); break;
    case 10: inactivePlayers = (gov.nasa.jpl.xdata.nba.impoexpo.InactivePlayers)(value); break;
    case 11: availableVideo = (gov.nasa.jpl.xdata.nba.impoexpo.AvailableVideo)(value); break;
    case 12: gameId = (java.lang.Integer)(value); break;
    case 13: rangeType = (java.lang.Integer)(value); break;
    case 14: startPeriod = (java.lang.Integer)(value); break;
    case 15: startRange = (java.lang.Integer)(value); break;
    case 16: endPeriod = (java.lang.Integer)(value); break;
    case 17: endRange = (java.lang.Integer)(value); break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
   ...
   */
  public gov.nasa.jpl.xdata.nba.impoexpo.GameSummary getGameSummary() {
    return gameSummary;
  }
   ...
   */
  public void setGameSummary(gov.nasa.jpl.xdata.nba.impoexpo.GameSummary value) {
   ...
   * @param value the value to set.
   */
  public boolean isGameSummaryDirty(gov.nasa.jpl.xdata.nba.impoexpo.GameSummary value) {
    return isDirty(1);
  }
   ...
   */
  public gov.nasa.jpl.xdata.nba.impoexpo.LineScore getLineScore() {
    return lineScore;
  }
   ...
   * @param value the value to set.
   */
  public void setLineScore(gov.nasa.jpl.xdata.nba.impoexpo.LineScore value) {
   ...
   * @param value the value to set.
   */
  public boolean isLineScoreDirty(gov.nasa.jpl.xdata.nba.impoexpo.LineScore value) {
    return isDirty(2);
  }
   ...
   */
  public gov.nasa.jpl.xdata.nba.impoexpo.SeasonSeries getSeasonSeries() {
    return seasonSeries;
  }
   ...
   * @param value the value to set.
   */
  public void setSeasonSeries(gov.nasa.jpl.xdata.nba.impoexpo.SeasonSeries value) {
   ...
   * @param value the value to set.
   */
  public boolean isSeasonSeriesDirty(gov.nasa.jpl.xdata.nba.impoexpo.SeasonSeries value) {
    return isDirty(3);
  }
   ...
   */
  public gov.nasa.jpl.xdata.nba.impoexpo.LastMeeting getLastMeeting() {
    return lastMeeting;
  }
   ...
   * @param value the value to set.
   */
  public void setLastMeeting(gov.nasa.jpl.xdata.nba.impoexpo.LastMeeting value) {
   ...
   * @param value the value to set.
   */
  public boolean isLastMeetingDirty(gov.nasa.jpl.xdata.nba.impoexpo.LastMeeting value) {
    return isDirty(4);
  }
   ...
   */
  public gov.nasa.jpl.xdata.nba.impoexpo.PlayerStats getPlayerStats() {
    return playerStats;
  }
   ...
   * @param value the value to set.
   */
  public void setPlayerStats(gov.nasa.jpl.xdata.nba.impoexpo.PlayerStats value) {
   ...
   * @param value the value to set.
   */
  public boolean isPlayerStatsDirty(gov.nasa.jpl.xdata.nba.impoexpo.PlayerStats value) {
    return isDirty(5);
  }
   ...
   */
  public gov.nasa.jpl.xdata.nba.impoexpo.TeamStats getTeamStats() {
    return teamStats;
  }
   ...
   * @param value the value to set.
   */
  public void setTeamStats(gov.nasa.jpl.xdata.nba.impoexpo.TeamStats value) {
   ...
   * @param value the value to set.
   */
  public boolean isTeamStatsDirty(gov.nasa.jpl.xdata.nba.impoexpo.TeamStats value) {
    return isDirty(6);
  }
   ...
   */
  public gov.nasa.jpl.xdata.nba.impoexpo.OtherStats getOtherStats() {
    return otherStats;
  }
   ...
   * @param value the value to set.
   */
  public void setOtherStats(gov.nasa.jpl.xdata.nba.impoexpo.OtherStats value) {
   ...
   * @param value the value to set.
   */
  public boolean isOtherStatsDirty(gov.nasa.jpl.xdata.nba.impoexpo.OtherStats value) {
    return isDirty(7);
  }
   ...
   */
  public gov.nasa.jpl.xdata.nba.impoexpo.Officials getOfficials() {
    return officials;
  }
   ...
   * @param value the value to set.
   */
  public void setOfficials(gov.nasa.jpl.xdata.nba.impoexpo.Officials value) {
   ...
   * @param value the value to set.
   */
  public boolean isOfficialsDirty(gov.nasa.jpl.xdata.nba.impoexpo.Officials value) {
    return isDirty(8);
  }
   ...
   */
  public gov.nasa.jpl.xdata.nba.impoexpo.GameInfo getGameInfo() {
    return gameInfo;
  }
   ...
   * @param value the value to set.
   */
  public void setGameInfo(gov.nasa.jpl.xdata.nba.impoexpo.GameInfo value) {
    this.gameInfo = value;
    setDirty(9);
  }
   ...
   * @param value the value to set.
   */
  public boolean isGameInfoDirty(gov.nasa.jpl.xdata.nba.impoexpo.GameInfo value) {
    return isDirty(9);
  }
   ...
   */
  public gov.nasa.jpl.xdata.nba.impoexpo.InactivePlayers getInactivePlayers() {
   ...
   * @param value the value to set.
   */
  public void setInactivePlayers(gov.nasa.jpl.xdata.nba.impoexpo.InactivePlayers value) {
   ...
   * @param value the value to set.
   */
  public boolean isInactivePlayersDirty(gov.nasa.jpl.xdata.nba.impoexpo.InactivePlayers value) {
    return isDirty(10);
  }
   ...
   */
  public gov.nasa.jpl.xdata.nba.impoexpo.AvailableVideo getAvailableVideo() {
   ...
   * @param value the value to set.
   */
  public void setAvailableVideo(gov.nasa.jpl.xdata.nba.impoexpo.AvailableVideo value) {
   ...
   * @param value the value to set.
   */
  public boolean isAvailableVideoDirty(gov.nasa.jpl.xdata.nba.impoexpo.AvailableVideo value) {
    return isDirty(11);
  }
  ...
  public static gov.nasa.jpl.xdata.nba.impoexpo.GameStats.Builder newBuilder() {
    return new gov.nasa.jpl.xdata.nba.impoexpo.GameStats.Builder();
  }
  
  /** Creates a new GameStats RecordBuilder by copying an existing Builder */
  public static gov.nasa.jpl.xdata.nba.impoexpo.GameStats.Builder newBuilder(gov.nasa.jpl.xdata.nba.impoexpo.GameStats.Builder other) {
    return new gov.nasa.jpl.xdata.nba.impoexpo.GameStats.Builder(other);
  }
  
  /** Creates a new GameStats RecordBuilder by copying an existing GameStats instance */
  public static gov.nasa.jpl.xdata.nba.impoexpo.GameStats.Builder newBuilder(gov.nasa.jpl.xdata.nba.impoexpo.GameStats other) {
    return new gov.nasa.jpl.xdata.nba.impoexpo.GameStats.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<GameStats>
    ...
    private Builder() {
      super(gov.nasa.jpl.xdata.nba.impoexpo.GameStats.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(gov.nasa.jpl.xdata.nba.impoexpo.GameStats.Builder other) {
      super(other);
    }
    
    /** Creates a Builder by copying an existing GameStats instance */
    private Builder(gov.nasa.jpl.xdata.nba.impoexpo.GameStats other) {
            super(gov.nasa.jpl.xdata.nba.impoexpo.GameStats.SCHEMA$);
      ...
      if (isValidValue(fields()[1], other.gameSummary)) {
        this.gameSummary = (gov.nasa.jpl.xdata.nba.impoexpo.GameSummary) data().deepCopy(fields()[1].schema(), other.gameSummary);
        fieldSetFlags()[1] = true;
      }
      if (isValidValue(fields()[2], other.lineScore)) {
        this.lineScore = (gov.nasa.jpl.xdata.nba.impoexpo.LineScore) data().deepCopy(fields()[2].schema(), other.lineScore);
        fieldSetFlags()[2] = true;
      }
      if (isValidValue(fields()[3], other.seasonSeries)) {
        this.seasonSeries = (gov.nasa.jpl.xdata.nba.impoexpo.SeasonSeries) data().deepCopy(fields()[3].schema(), other.seasonSeries);
        fieldSetFlags()[3] = true;
      }
      if (isValidValue(fields()[4], other.lastMeeting)) {
        this.lastMeeting = (gov.nasa.jpl.xdata.nba.impoexpo.LastMeeting) data().deepCopy(fields()[4].schema(), other.lastMeeting);
        fieldSetFlags()[4] = true;
      }
      if (isValidValue(fields()[5], other.playerStats)) {
        this.playerStats = (gov.nasa.jpl.xdata.nba.impoexpo.PlayerStats) data().deepCopy(fields()[5].schema(), other.playerStats);
        fieldSetFlags()[5] = true;
      }
      if (isValidValue(fields()[6], other.teamStats)) {
        this.teamStats = (gov.nasa.jpl.xdata.nba.impoexpo.TeamStats) data().deepCopy(fields()[6].schema(), other.teamStats);
        fieldSetFlags()[6] = true;
      }
      if (isValidValue(fields()[7], other.otherStats)) {
        this.otherStats = (gov.nasa.jpl.xdata.nba.impoexpo.OtherStats) data().deepCopy(fields()[7].schema(), other.otherStats);
        fieldSetFlags()[7] = true;
      }
      if (isValidValue(fields()[8], other.officials)) {
        this.officials = (gov.nasa.jpl.xdata.nba.impoexpo.Officials) data().deepCopy(fields()[8].schema(), other.officials);
        fieldSetFlags()[8] = true;
      }
      if (isValidValue(fields()[9], other.gameInfo)) {
        this.gameInfo = (gov.nasa.jpl.xdata.nba.impoexpo.GameInfo) data().deepCopy(fields()[9].schema(), other.gameInfo);
        fieldSetFlags()[9] = true;
      }
      if (isValidValue(fields()[10], other.inactivePlayers)) {
        this.inactivePlayers = (gov.nasa.jpl.xdata.nba.impoexpo.InactivePlayers) data().deepCopy(fields()[10].schema(), other.inactivePlayers);
        fieldSetFlags()[10] = true;
      }
      if (isValidValue(fields()[11], other.availableVideo)) {
        this.availableVideo = (gov.nasa.jpl.xdata.nba.impoexpo.AvailableVideo) data().deepCopy(fields()[11].schema(), other.availableVideo);
        fieldSetFlags()[11] = true;
      }
      if (isValidValue(fields()[12], other.gameId)) {
        this.gameId = (java.lang.Integer) data().deepCopy(fields()[12].schema(), other.gameId);
        fieldSetFlags()[12] = true;
      }
      if (isValidValue(fields()[13], other.rangeType)) {
        this.rangeType = (java.lang.Integer) data().deepCopy(fields()[13].schema(), other.rangeType);
        fieldSetFlags()[13] = true;
      }
      if (isValidValue(fields()[14], other.startPeriod)) {
        this.startPeriod = (java.lang.Integer) data().deepCopy(fields()[14].schema(), other.startPeriod);
        fieldSetFlags()[14] = true;
      }
      if (isValidValue(fields()[15], other.startRange)) {
        this.startRange = (java.lang.Integer) data().deepCopy(fields()[15].schema(), other.startRange);
        fieldSetFlags()[15] = true;
      }
      if (isValidValue(fields()[16], other.endPeriod)) {
        this.endPeriod = (java.lang.Integer) data().deepCopy(fields()[16].schema(), other.endPeriod);
        fieldSetFlags()[16] = true;
      }
      if (isValidValue(fields()[17], other.endRange)) {
        this.endRange = (java.lang.Integer) data().deepCopy(fields()[17].schema(), other.endRange);
    ...
    /** Sets the value of the 'gameSummary' field */
    public gov.nasa.jpl.xdata.nba.impoexpo.GameStats.Builder setGameSummary(gov.nasa.jpl.xdata.nba.impoexpo.GameSummary value) {
    ...
    public gov.nasa.jpl.xdata.nba.impoexpo.GameStats.Builder clearGameSummary() {
      gameSummary = null;
    ...
    /** Sets the value of the 'lineScore' field */
    public gov.nasa.jpl.xdata.nba.impoexpo.GameStats.Builder setLineScore(gov.nasa.jpl.xdata.nba.impoexpo.LineScore value) {
    ...
    public gov.nasa.jpl.xdata.nba.impoexpo.GameStats.Builder clearLineScore() {
      lineScore = null;
    ...
    /** Sets the value of the 'seasonSeries' field */
    public gov.nasa.jpl.xdata.nba.impoexpo.GameStats.Builder setSeasonSeries(gov.nasa.jpl.xdata.nba.impoexpo.SeasonSeries value) {
    ...
    public gov.nasa.jpl.xdata.nba.impoexpo.GameStats.Builder clearSeasonSeries() {
      seasonSeries = null;
    ...
    /** Sets the value of the 'lastMeeting' field */
    public gov.nasa.jpl.xdata.nba.impoexpo.GameStats.Builder setLastMeeting(gov.nasa.jpl.xdata.nba.impoexpo.LastMeeting value) {
    ...
    public gov.nasa.jpl.xdata.nba.impoexpo.GameStats.Builder clearLastMeeting() {
      lastMeeting = null;
    ...
    /** Sets the value of the 'playerStats' field */
    public gov.nasa.jpl.xdata.nba.impoexpo.GameStats.Builder setPlayerStats(gov.nasa.jpl.xdata.nba.impoexpo.PlayerStats value) {
    ...
    public gov.nasa.jpl.xdata.nba.impoexpo.GameStats.Builder clearPlayerStats() {
      playerStats = null;
    ...
    /** Sets the value of the 'teamStats' field */
    public gov.nasa.jpl.xdata.nba.impoexpo.GameStats.Builder setTeamStats(gov.nasa.jpl.xdata.nba.impoexpo.TeamStats value) {
    ...
    public gov.nasa.jpl.xdata.nba.impoexpo.GameStats.Builder clearTeamStats() {
      teamStats = null;
    ...
    /** Sets the value of the 'otherStats' field */
    public gov.nasa.jpl.xdata.nba.impoexpo.GameStats.Builder setOtherStats(gov.nasa.jpl.xdata.nba.impoexpo.OtherStats value) {
    ...
    public gov.nasa.jpl.xdata.nba.impoexpo.GameStats.Builder clearOtherStats() {
      otherStats = null;
    ...
    /** Sets the value of the 'officials' field */
    public gov.nasa.jpl.xdata.nba.impoexpo.GameStats.Builder setOfficials(gov.nasa.jpl.xdata.nba.impoexpo.Officials value) {
    ...
    public gov.nasa.jpl.xdata.nba.impoexpo.GameStats.Builder clearOfficials() {
      officials = null;
    ...
    /** Sets the value of the 'gameInfo' field */
    public gov.nasa.jpl.xdata.nba.impoexpo.GameStats.Builder setGameInfo(gov.nasa.jpl.xdata.nba.impoexpo.GameInfo value) {
    ...
    public gov.nasa.jpl.xdata.nba.impoexpo.GameStats.Builder clearGameInfo() {
      gameInfo = null;
    ...
    /** Sets the value of the 'inactivePlayers' field */
    public gov.nasa.jpl.xdata.nba.impoexpo.GameStats.Builder setInactivePlayers(gov.nasa.jpl.xdata.nba.impoexpo.InactivePlayers value) {
    ...
    public gov.nasa.jpl.xdata.nba.impoexpo.GameStats.Builder clearInactivePlayers() {
    ...
    /** Sets the value of the 'availableVideo' field */
    public gov.nasa.jpl.xdata.nba.impoexpo.GameStats.Builder setAvailableVideo(gov.nasa.jpl.xdata.nba.impoexpo.AvailableVideo value) {
    ...
    public gov.nasa.jpl.xdata.nba.impoexpo.GameStats.Builder clearAvailableVideo() {
      availableVideo = null;
    ...
    /** Sets the value of the 'gameId' field */
    public gov.nasa.jpl.xdata.nba.impoexpo.GameStats.Builder setGameId(int value) {
    ...
    public gov.nasa.jpl.xdata.nba.impoexpo.GameStats.Builder clearGameId() {
    ...
    /** Sets the value of the 'rangeType' field */
    public gov.nasa.jpl.xdata.nba.impoexpo.GameStats.Builder setRangeType(int value) {
    ...
    public gov.nasa.jpl.xdata.nba.impoexpo.GameStats.Builder clearRangeType() {
    ...
    /** Sets the value of the 'startPeriod' field */
    public gov.nasa.jpl.xdata.nba.impoexpo.GameStats.Builder setStartPeriod(int value) {
    ...
    public gov.nasa.jpl.xdata.nba.impoexpo.GameStats.Builder clearStartPeriod() {
    ...
    /** Sets the value of the 'startRange' field */
    public gov.nasa.jpl.xdata.nba.impoexpo.GameStats.Builder setStartRange(int value) {
    ...
    public gov.nasa.jpl.xdata.nba.impoexpo.GameStats.Builder clearStartRange() {
    ...
    /** Sets the value of the 'endPeriod' field */
    public gov.nasa.jpl.xdata.nba.impoexpo.GameStats.Builder setEndPeriod(int value) {
    ...
    public gov.nasa.jpl.xdata.nba.impoexpo.GameStats.Builder clearEndPeriod() {
    ...
    /** Sets the value of the 'endRange' field */
    public gov.nasa.jpl.xdata.nba.impoexpo.GameStats.Builder setEndRange(int value) {
    ...
    public gov.nasa.jpl.xdata.nba.impoexpo.GameStats.Builder clearEndRange() {
    ...
    public GameStats build() {
      try {
        ...
        record.gameSummary = fieldSetFlags()[1] ? this.gameSummary : (gov.nasa.jpl.xdata.nba.impoexpo.GameSummary) defaultValue(fields()[1]);
        record.lineScore = fieldSetFlags()[2] ? this.lineScore : (gov.nasa.jpl.xdata.nba.impoexpo.LineScore) defaultValue(fields()[2]);
        record.seasonSeries = fieldSetFlags()[3] ? this.seasonSeries : (gov.nasa.jpl.xdata.nba.impoexpo.SeasonSeries) defaultValue(fields()[3]);
        record.lastMeeting = fieldSetFlags()[4] ? this.lastMeeting : (gov.nasa.jpl.xdata.nba.impoexpo.LastMeeting) defaultValue(fields()[4]);
        record.playerStats = fieldSetFlags()[5] ? this.playerStats : (gov.nasa.jpl.xdata.nba.impoexpo.PlayerStats) defaultValue(fields()[5]);
        record.teamStats = fieldSetFlags()[6] ? this.teamStats : (gov.nasa.jpl.xdata.nba.impoexpo.TeamStats) defaultValue(fields()[6]);
        record.otherStats = fieldSetFlags()[7] ? this.otherStats : (gov.nasa.jpl.xdata.nba.impoexpo.OtherStats) defaultValue(fields()[7]);
        record.officials = fieldSetFlags()[8] ? this.officials : (gov.nasa.jpl.xdata.nba.impoexpo.Officials) defaultValue(fields()[8]);
        record.gameInfo = fieldSetFlags()[9] ? this.gameInfo : (gov.nasa.jpl.xdata.nba.impoexpo.GameInfo) defaultValue(fields()[9]);
        record.inactivePlayers = fieldSetFlags()[10] ? this.inactivePlayers : (gov.nasa.jpl.xdata.nba.impoexpo.InactivePlayers) defaultValue(fields()[10]);
        record.availableVideo = fieldSetFlags()[11] ? this.availableVideo : (gov.nasa.jpl.xdata.nba.impoexpo.AvailableVideo) defaultValue(fields()[11]);
        record.gameId = fieldSetFlags()[12] ? this.gameId : (java.lang.Integer) defaultValue(fields()[12]);
        record.rangeType = fieldSetFlags()[13] ? this.rangeType : (java.lang.Integer) defaultValue(fields()[13]);
        record.startPeriod = fieldSetFlags()[14] ? this.startPeriod : (java.lang.Integer) defaultValue(fields()[14]);
        record.startRange = fieldSetFlags()[15] ? this.startRange : (java.lang.Integer) defaultValue(fields()[15]);
        record.endPeriod = fieldSetFlags()[16] ? this.endPeriod : (java.lang.Integer) defaultValue(fields()[16]);
        record.endRange = fieldSetFlags()[17] ? this.endRange : (java.lang.Integer) defaultValue(fields()[17]);
        return record;
      } catch (Exception e) {
